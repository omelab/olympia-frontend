...
import { contactListKeys } from "./contact-list-keys"
...
const ContactList = () => {
  ...
  const { data, isFetching, refetch } =
    useGetAllSystemSettingsQuery("?type=Contact")
  ...
  return (
    <div className="py-4">
      ...
      <div>
        <Modal
          title={<h4 className="text-center text-lg">Add Contact Data</h4>}
          centered
          open={isTagModalOpen}
        ...
        >
          <Formik
            ...
            onSubmit={(values) => {
              const data = { key: values.key, value: values.value,   type: "Contact" }
              createHandler(data)
            }}
          >
